...
1. 6 variables
2. The highest weights are 0.93, 0.93 and 0.86
3. The first 10 components are: Government bonds, Foreign exchange currency, European Market indices, North American Market indices, Euro bonds/interest rates, Oil-based commodities, Metals, Agri-based food commodities, Precious metals, SE Asian indices.  
4.
```{r}
...
5. During bear years assets are more correlated and it's easier to describe economy with less parameters.
*
*
*
*
